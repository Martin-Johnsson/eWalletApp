...
const StartPage = () => {
  return (
    <section>
      <p>
        <GiWallet className='wallet-icon' /> E-wallet
      </p>
      <main>
      ...
      <h2>
        ...
        reprehenderit ratione doloribus numquam incidunt amet, unde aut eaque
        quos odit inventore alias magnam. Corrupti assumenda amet laborum et ea!
      </h2>
